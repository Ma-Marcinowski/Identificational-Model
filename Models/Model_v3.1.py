...
model.compile(optimizer=Adam, 
              ...
              loss_weights={'authors': 2.0, 'features': 1.0}, 
...
checkpoint = tf.keras.callbacks.ModelCheckpoint(filepath='/path/IM_v3.1-{epoch:02d}-{val_authors_categorical_accuracy:.2f}.h5',
